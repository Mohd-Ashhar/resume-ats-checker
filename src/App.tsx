  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://ashhar.app.n8n.cloud/webhook-test/ats-resume",
        {
          method: "POST",
      ...
      const matchScore = data?.matchScore || data?.match_score || "0%";
      const rawMissingSkills = data?.missingSkills || data?.missing_skills;
      const missingSkills = Array.isArray(rawMissingSkills)
        ? rawMissingSkills
        : [];
      const feedback =
        data?.feedback || data?.analysis || "Analysis completed successfully.";
              ...
              <div className="bg-orange-50 rounded-xl p-6">
                ...
                {result.missingSkills.length > 0 ? (
                  ...
                  <p className="text-gray-600 italic">
                    Great! No missing skills identified.
                  </p>
                )}
              </div>
